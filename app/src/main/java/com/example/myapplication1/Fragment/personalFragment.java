...
public class personalFragment extends Fragment {
    ...
    private ArrayList<Project> personalProjects = new ArrayList<>();
        ...
        FirebaseDatabase.getInstance().getReference("Personal").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot snap : snapshot.getChildren()) {
                    ...
                    if (ps.getIDUserOwn().equals(IDuser)) {
                        personalProjects.add(ps);
                    }
                }

                RecyclerView recyclerView = (RecyclerView) view.findViewById(R.id.recycle_view_show_personal);
                RecyclerViewProjectAdapter adapterPersonal = new RecyclerViewProjectAdapter(getContext(), personalProjects);
